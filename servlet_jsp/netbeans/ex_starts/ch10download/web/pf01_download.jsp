...
<tr><td>64 Corvair</td>
    <td><a href="/musicStore/sound/<jsp:getProperty name="product" property="code"/>/corvair.mp3">MP3</a></td>
</tr>
<tr><td>Whiskey Before Breakfast</td>
    <td><a href="/musicStore/sound/<jsp:getProperty name="product" property="code"/>/whiskey.mp3">MP3</a></td>
</tr>
</table>
