...
<tr><td>Filter</td>
    <td><a href="/musicStore/sound/<jsp:getProperty name="product" property="code"/>/filter.mp3">MP3</a></td>
</tr>
<tr><td>So Long Lazy Ray</td>
    <td><a href="/musicStore/sound/<jsp:getProperty name="product" property="code"/>/so_long.mp3">MP3</a></td>
</tr>
</table>
